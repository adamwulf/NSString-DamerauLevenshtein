...
- (void)test_case_insensitive {
    NSUInteger levensteinDistance = [@"a" distanceFromString:@"A"
...
- (void)test_literal {
    ...
    NSUInteger levensteinDistance = [nWithTilde distanceFromString:nWithTildeDecomposed
                                                options:0];
...
- (void)test_whitespace_insensitive {
    ...
    NSUInteger levensteinDistance = [textWithWhitespace distanceFromString:textWithoutWhitespace
                                                        options:0];
...
- (void)test_diacritics {
    ...
    NSUInteger levensteinDistance = [textWithDiacritics distanceFromString:textWithoutDiacritics
                                                        options:0];
...
- (void)test_width {
    ...
    NSUInteger levensteinDistance = [normalA distanceFromString:wideA
                                             options:0];
...
- (void)test_delimiters {
    ...
    NSUInteger levensteinDistance = [textWithDelimiters distanceFromString:textWithoutDelimiters
                                                        options:0];
...
- (void)test_quote_types {
    ...
    NSUInteger levensteinDistance = [textWithSmartQuotes distanceFromString:textWithStraightQuotes
                                                         options:0];
...
- (void)test_performance {
    NSUInteger levensteinDistance = [DamerauLevenshteinTestsLongString1 distanceFromString:DamerauLevenshteinTestsLongString2];
